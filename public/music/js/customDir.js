    ...
    render() {
        ...
        page.list.forEach((item, pageIndex) => {
            ...
            if (item.subPath) {
                ...
                mobileSubPathHtml = `<span class="text-emerald-500 font-mono truncate max-w-[80px] italic flex items-center gap-0.5"><i class="far fa-folder mr-0.5 opacity-70"></i>${safeSubPath}</span>`;
            } else {
                ...
                mobileSubPathHtml = `<span class="text-emerald-500 font-mono truncate max-w-[60px] italic flex items-center gap-0.5"><i class="far fa-folder mr-0.5 opacity-70"></i>根目录</span>`;
            }
